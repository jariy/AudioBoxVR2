...
public class particleDeviceInterface : deviceInterface
{
    ...
    void UpdateColor()
    {
        ...
        targetParticles.GetComponent<ParticleSea>().defaultColor = new Color(colorDialRed.percent, colorDialBlue.percent, colorDialGreen.percent);
    }
    ...
    {
        if (externalPulse == null) { activated = false; return; }
        activated = true;
...
public class ParticlerigData : InstrumentData
{
    public int inputID;
